...
/**
 * Servlet implementation class EditCheckTestInput
 */
@WebServlet("/EditCheckTestInput")
public class EditCheckTestInput extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditCheckTestInput() {
        super();
