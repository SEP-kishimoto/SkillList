...
/**
 * Servlet implementation class EditCommitTestInput
 */
@WebServlet("/EditCommitTestInputData")
public class EditCommitTestInputData extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditCommitTestInputData() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    master_flg = "1"; // 0の場合も見る
	    session.setAttribute("master_flg", master_flg);

		String view = "/test/EditCommitTestInput.jsp";
